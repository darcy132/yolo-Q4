...
def get_multiplier(class_id: int) -> int:
    return CLASS_MULTIPLIERS.get(class_id, 1)
...
def parse_args():
    ...
    p.add_argument("--src_dir",       default="/home/forge/workspace/yolo-Q4/dataset_cz",
                   help="原始数据集根目录（含 images/labels 子目录）")
    p.add_argument("--out_dir",       default="/home/forge/workspace/yolo-Q4/dataset_cz_aug",
                   help="输出数据集根目录")
